"""
Django settings for static_apps project.
...
SECRET_KEY = 'django-insecure-)f7(wj&4jioezlm!@5tqw0@0z_9s44cj73pxj@!7c*-9^mz8ti'
...
WSGI_APPLICATION = 'static_apps.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.environ.get('STATIC_APPS_DEFAULT_FROM_EMAIL')
